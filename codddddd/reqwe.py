...
url = 'https://book.douban.com/top250?start=75'

resp = requests.get(url=url, headers=headers, timeout=10)
# print("响应状态码:", resp.status_code)
# if 200 != resp.status_code:
#     return 404
htmlw = etree.HTML(resp.text)
for i in range(25):
    html = htmlw.xpath('//div[@class="indent"]/table[{}]//tr[@class="item"]'.format(i+1))
    ...
    # for i in rating_people_:https://book.douban.com/subject/1011754/
    #     e = re.findall('\d+',i)
