...
# 基本信息
data["spider_class"] = "Qnck"
data["spider_name"] = "青年参考"
# 时间参数留空
data["base_url"] = "http://qnck.cyol.com/html/{}/nbs.D110000qnck_01.htm"
...
data["image_links_xpath"] = '//div[@class="c_c BSHARE_POP"]//img/@src'      # 图片link
data["images_desc_xpath"] = '//div[@class="tushuo"]/text()'
